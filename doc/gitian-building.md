Gitian building
================
*Setup instructions for a Gitian build of AlveyCoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the AlveyCoin
...
- [Building AlveyCoin Core](#building-alvey-core)
...
To build AlveyCoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
