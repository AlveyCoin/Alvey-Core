...
3. Update `src/qt/bitcoin_locale.lrc` manually or via
```bash
...
To create a new language template, you will need to edit the languages manifest file `src/qt/bitcoin_locale.lrc` and add a new entry. Below is an example of the English language entry.
