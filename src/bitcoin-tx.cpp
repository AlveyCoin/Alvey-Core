...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " alvey-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  alvey-tx [options] <hex-tx> [commands]  Update hex-encoded alvey transaction\n" +
            "or:     alvey-tx [options] -create [commands]   Create hex-encoded alvey transaction\n" +
            "\n";
