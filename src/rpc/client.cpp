...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "arc20listtransactions", 2, "fromBlock"},
    { "arc20listtransactions", 3, "minconf"},
    //////////////////////////////////////////////////
    ...
    { "arc20approve", 4, "gasLimit" },
    { "arc20approve", 5, "gasPrice" },
    { "arc20approve", 6, "checkOutputs" },
    { "arc20transfer", 4, "gasLimit" },
    { "arc20transfer", 5, "gasPrice" },
    { "arc20transfer", 6, "checkOutputs" },
    { "arc20transferfrom", 5, "gasLimit" },
    { "arc20transferfrom", 6, "gasPrice" },
    { "arc20transferfrom", 7, "checkOutputs" },
    { "arc20burn", 3, "gasLimit" },
    { "arc20burn", 4, "gasPrice" },
    { "arc20burn", 5, "checkOutputs" },
    { "arc20burnfrom", 4, "gasLimit" },
    { "arc20burnfrom", 5, "gasPrice" },
    { "arc20burnfrom", 6, "checkOutputs" },
