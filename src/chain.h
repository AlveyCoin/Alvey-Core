...
public:
    ...
    bool IsProofOfWork() const // alvey
    {
...
public:
    ...
    SERIALIZE_METHODS(CDiskBlockIndex, obj)
    {
        ...
        READWRITE(obj.hashStateRoot); // alvey
        READWRITE(obj.hashUTXORoot); // alvey
        READWRITE(obj.nStakeModifier);
        READWRITE(obj.prevoutStake);
        READWRITE(obj.hashProof);
        READWRITE(obj.vchBlockSigDlgt); // alvey
    }
