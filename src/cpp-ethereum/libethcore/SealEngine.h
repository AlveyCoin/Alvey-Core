...
////////////////////////////////////////////////////////////// // alvey
    void setAlveyCoinSchedule(EVMSchedule _alveySchedule) const { alveySchedule = _alveySchedule; }

    EVMSchedule& getAlveyCoinSchedule() const { return alveySchedule; }
...
private:
    ...
    mutable EVMSchedule alveySchedule; // alvey
