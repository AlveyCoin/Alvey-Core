...
#include "genesis/alveyMainNetwork.cpp"
...
#include "genesis/test/alveyTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::alveyMainNetwork: return c_genesisInfoAlveyCoinMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::alveyTestNetwork: return c_genesisInfoAlveyCoinTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::alveyMainNetwork: return c_genesisStateRootAlveyCoinMainNetwork;
    case Network::alveyTestNetwork: return c_genesisStateRootAlveyCoinTestNetwork;
