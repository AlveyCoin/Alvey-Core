...
//    initState();
    ...
    std::vector<AlveyCoinTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createAlveyCoinTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createAlveyCoinTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createAlveyCoinTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createAlveyCoinTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
