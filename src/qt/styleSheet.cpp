...
class AlveyCoinStyle : public QProxyStyle
{
public:
    AlveyCoinStyle()
    {
...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    AlveyCoinStyle* alveyStyle = new AlveyCoinStyle;
    alveyStyle->setBaseStyle(mainStyle);
    app->setStyle(alveyStyle);
...
{
    return QStringList() << "Light green theme" << "Dark blue theme" << "Dark theme";
}
