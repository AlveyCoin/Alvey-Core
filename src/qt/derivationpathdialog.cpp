    ...
    ui(new Ui::DerivationPathDialog)
{
    ...
    ui->txtLegacy->setText(AlveyCoinHwiTool::derivationPathPKH());
    ui->txtLegacy->setPlaceholderText(AlveyCoinHwiTool::derivationPathPKH());
    ...
    ui->txtP2SH->setText(AlveyCoinHwiTool::derivationPathP2SH());
    ui->txtP2SH->setPlaceholderText(AlveyCoinHwiTool::derivationPathP2SH());
    ...
    ui->txtSegWit->setText(AlveyCoinHwiTool::derivationPathBech32());
    ui->txtSegWit->setPlaceholderText(AlveyCoinHwiTool::derivationPathBech32());
