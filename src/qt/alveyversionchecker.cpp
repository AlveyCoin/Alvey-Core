...
AlveyCoinVersionChecker::AlveyCoinVersionChecker(QObject *parent) : QObject(parent)
{
    currentVersion = Version(CLIENT_VERSION_MAJOR, CLIENT_VERSION_MINOR, CLIENT_VERSION_REVISION);
}

AlveyCoinVersionChecker::~AlveyCoinVersionChecker()
{

}

bool AlveyCoinVersionChecker::newVersionAvailable()
{
...
Version AlveyCoinVersionChecker::getMaxReleaseVersion()
{
