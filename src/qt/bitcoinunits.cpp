...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ALV");
    case mBTC: return QString("mALV");
    case uBTC: return QString::fromUtf8("μALV (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("AlveyCoins");
    case mBTC: return QString("Milli-AlveyCoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-AlveyCoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
