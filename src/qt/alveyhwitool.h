...
/**
 * @brief The AlveyCoinHwiTool class Communicate with the AlveyCoin Hardware Wallet Interface Tool
 */
class AlveyCoinHwiTool : public QObject
{
    Q_OBJECT
public:
    /**
     * @brief AlveyCoinHwiTool Constructor
     * @param parent Parent object
     */
    explicit AlveyCoinHwiTool(QObject *parent = nullptr);

    /**
     * @brief ~AlveyCoinHwiTool Destructor
     */
    ~AlveyCoinHwiTool();
