...
/**
 * @brief The AlveyCoinLedger class Communicate with the alvey ledger
 */
class AlveyCoinLedger {
    
public:
    /**
     * @brief AlveyCoinLedger Constructor
     */
    AlveyCoinLedger();

    /**
     * @brief ~AlveyCoinLedger Destructor
     */
    virtual ~AlveyCoinLedger();
     ...
     * @return
     */
    static AlveyCoinLedger &instance();
...
private:
    AlveyCoinLedger(const AlveyCoinLedger&);
    AlveyCoinLedger& operator=(const AlveyCoinLedger&);
    AlveyCoinLedgerPriv* d;
};
#endif
