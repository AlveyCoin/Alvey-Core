...
/**
 * @brief The IAlveyCoinStaker class Delegation filter
 */
...
/**
 * @brief The AlveyCoinDelegation class Communicate with the alvey delegation contract
 */
class AlveyCoinDelegation {
    
public:
    /**
     * @brief AlveyCoinDelegation Constructor
     */
    AlveyCoinDelegation();

    /**
     * @brief ~AlveyCoinDelegation Destructor
     */
    virtual ~AlveyCoinDelegation();
...
private:
    AlveyCoinDelegation(const AlveyCoinDelegation&);
    AlveyCoinDelegation& operator=(const AlveyCoinDelegation&);
    AlveyCoinDelegationPriv* priv;
};
#endif
