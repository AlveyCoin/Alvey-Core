...
public:
    ...
    virtual ~AlveyCoinTokenExec();
};

class AlveyCoinToken
{
public:
    AlveyCoinToken();
    virtual ~AlveyCoinToken();

    void setAlveyCoinTokenExec(AlveyCoinTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strAlveyCoinAddress, std::string& strHash160);
    static bool ToAlveyCoinAddress(const std::string& strHash160, std::string& strAlveyCoinAddress);
...
private:
    ...
    AlveyCoinToken(AlveyCoinToken const&);
    AlveyCoinToken& operator=(AlveyCoinToken const&);
