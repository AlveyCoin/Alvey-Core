...
from test_framework.alveyconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class AlveyCoinRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    AlveyCoinRPCSearchlogsTestModified().main()