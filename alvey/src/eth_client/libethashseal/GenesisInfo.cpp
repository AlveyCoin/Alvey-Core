...
#include "genesis/alveyNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::alveyNetwork: return c_genesisInfoAlveyNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::alveyNetwork: return c_genesisStateRootAlveyNetwork;
    default:
        throw std::invalid_argument("Invalid network value");
    }
}
...
std::string dev::eth::genesisInfoAlvey(Network _n, EVMConsensus _consensus)
{
