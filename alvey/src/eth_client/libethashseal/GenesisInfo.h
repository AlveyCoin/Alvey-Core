...
/// Set the improvements activation blocks for Alvey
struct EVMConsensus
{
    EVMConsensus() {}
...
/**
 * @brief genesisInfoAlvey Get the genesis information for EVM
 * @param _n Network type
 * @param _consensus Alvey network consensus parameters (mainnet, testnet, signet or regtest parameters)
 * @return Genesis information for EVM
 */
std::string genesisInfoAlvey(Network _n, EVMConsensus _consensus);
