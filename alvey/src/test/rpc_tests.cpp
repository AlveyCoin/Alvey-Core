...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(80000000024999990LL).write() == "800000000.24999990");
    BOOST_CHECK(ValueFromAmount(80000000024999999LL).write() == "800000000.24999999");
    BOOST_CHECK(ValueFromAmount(80000000025000000LL).write() == "800000000.25000000");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("800000000.2499999")), 80000000024999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("800000000.24999999")), 80000000024999999LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("800000000.25")), 80000000025000000LL);
...
BOOST_AUTO_TEST_CASE(help_example)
{
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", args), "> alvey-cli -named test foo=bar b=true n=1\n");
    ...
    // test shell escape
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b'ar"}}), "> alvey-cli -named test foo='b'''ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b\"ar"}}), "> alvey-cli -named test foo='b\"ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b ar"}}), "> alvey-cli -named test foo='b ar'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", obj_value}}), "> alvey-cli -named test name='{\"foo\":\"bar\",\"b\":false,\"n\":1}'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", arr_value}}), "> alvey-cli -named test name='[\"bar\",false,1]'\n");
