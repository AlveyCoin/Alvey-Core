...
////////////////////////////////////////////////////////////// alvey
    ...
    globalState = std::unique_ptr<AlveyState>(new AlveyState(dev::u256(0), AlveyState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
