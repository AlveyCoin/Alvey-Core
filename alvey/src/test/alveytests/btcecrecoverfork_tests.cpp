...
//    initState();
    ...
    std::vector<AlveyTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createAlveyTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createAlveyTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createAlveyTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createAlveyTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
