...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000000100650065"); // 100
        consensus.defaultAssumeValid = uint256S("0x0000a6767f046c5e6ea1420278a6c589c5a359162f1774347488b93ae374a478"); // 100
        ...
        // vSeeds.emplace_back("alvey3.dynu.net"); // Alvey mainnet
        // vSeeds.emplace_back("alvey5.dynu.net"); // Alvey mainnet
        // vSeeds.emplace_back("alvey6.dynu.net"); // Alvey mainnet
        // vSeeds.emplace_back("alvey7.dynu.net"); // Alvey mainnet
        ...
        checkpointData = {
            {
                ...
                { 100, uint256S("0000a6767f046c5e6ea1420278a6c589c5a359162f1774347488b93ae374a478")},
                { 200, uint256S("0000414d92286611c547bfa51dacafb1f042d78b010618990cbba9e6d09d31db")},
                { 300, uint256S("0000d4d83f146a3ea2ec2bf834530a3dab19beca8cfcdd2dfa572ff5cc530eb6")},
                { 400, uint256S("000004beef12abb66739af0523f71d4216f0f19c78d6290e8ef73d543cdc828b")},
                { 500, uint256S("000040e657c914a927e79651de8d301f3d9d1a92b8e8e3c161302cfa89d364cd")},
            }
        };
        ...
        chainTxData = ChainTxData{
        	...
        	1653516795, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // consensus.nMinimumChainWork = uint256S("0x00"); // 1930000
        // consensus.defaultAssumeValid = uint256S("0x00"); // 1930000
        ...
        // vSeeds.emplace_back("alvey4.dynu.net"); // Alvey testnet
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1663720005, 3538615392, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000851d732c1ae349c5ba039a8e223a45ab56779c928e1befaeeb5fbcb3"));
        assert(genesis.hashMerkleRoot == uint256S("0x6d61616ae968ecdaf3c4d81c2956ee78132e515ea51f9dcd85df2c2cc7b780b6"));
...
std::string CChainParams::EVMGenesisInfo() const
{
    ...
    return dev::eth::genesisInfoAlvey(GetEVMNetwork(), evmConsensus);
}
...
{
    return dev::eth::Network::alveyNetwork;
}
