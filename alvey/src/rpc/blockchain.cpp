        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    AlveyDelegation alveyDelegation;
    Delegation delegation;
    PKHash pkhash = std::get<PKHash>(dest);
    uint160 address = uint160(pkhash);
    if(!alveyDelegation.GetDelegation(address, delegation, chainman.ActiveChainstate())) {
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if(!alveyDelegation.FilterDelegationEvents(events, filter, chainman)) {
        ...
        },
        {
            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "", {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "", {
                    ...
                    {RPCResult::Type::STR, "address", /* optional */ true, "alvey address (only if a well-defined address exists)"},
                    {RPCResult::Type::ARR, "addresses", /* optional */ true, "(DEPRECATED, returned only if config option -deprecatedrpc=addresses is passed) Array of alvey addresses",
...
static RPCHelpMan arc20listtransactions()
{
    return RPCHelpMan{"arc20listtransactions",
                ...
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address."},
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO,  "The alvey address to get history for."},
