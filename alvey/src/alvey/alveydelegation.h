...
/**
 * @brief The IAlveyStaker class Delegation filter
 */
...
/**
 * @brief The AlveyDelegation class Communicate with the alvey delegation contract
 */
class AlveyDelegation {
    
public:
    /**
     * @brief AlveyDelegation Constructor
     */
    AlveyDelegation();

    /**
     * @brief ~AlveyDelegation Destructor
     */
    virtual ~AlveyDelegation();
...
private:
    AlveyDelegation(const AlveyDelegation&);
    AlveyDelegation& operator=(const AlveyDelegation&);
    AlveyDelegationPriv* priv;
};
#endif
