...
public:
    ...
    void setAlveyTokenExec(AlveyTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strAlveyAddress, std::string& strHash160);
    static bool ToAlveyAddress(const std::string& strHash160, std::string& strAlveyAddress);
...
private:
    ...
    AlveyToken(AlveyToken const&);
    AlveyToken& operator=(AlveyToken const&);
