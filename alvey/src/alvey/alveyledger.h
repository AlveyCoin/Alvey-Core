...
/**
 * @brief The AlveyLedger class Communicate with the alvey ledger
 */
class AlveyLedger {
    
public:
    /**
     * @brief AlveyLedger Constructor
     */
    AlveyLedger();

    /**
     * @brief ~AlveyLedger Destructor
     */
    virtual ~AlveyLedger();
...
private:
    AlveyLedger(const AlveyLedger&);
    AlveyLedger& operator=(const AlveyLedger&);
    AlveyLedgerPriv* d;
};
#endif
