...
{
    // Windows: C:\Users\Username\AppData\Roaming\Alvey
    // macOS: ~/Library/Application Support/Alvey
    // Unix-like: ~/.alvey
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Alvey";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Alvey";
#else
    // Unix-like
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Alvey Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Alvey Core Developers";
    }
