    ...
    ui(new Ui::DerivationPathDialog)
{
    ...
    ui->txtLegacy->setText(AlveyHwiTool::derivationPathPKH());
    ui->txtLegacy->setPlaceholderText(AlveyHwiTool::derivationPathPKH());
    ...
    ui->txtP2SH->setText(AlveyHwiTool::derivationPathP2SH());
    ui->txtP2SH->setPlaceholderText(AlveyHwiTool::derivationPathP2SH());
    ...
    ui->txtSegWit->setText(AlveyHwiTool::derivationPathBech32());
    ui->txtSegWit->setPlaceholderText(AlveyHwiTool::derivationPathBech32());
