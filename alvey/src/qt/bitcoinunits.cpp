...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Alveys");
    case mBTC: return QString("Milli-Alveys (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Alveys (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
