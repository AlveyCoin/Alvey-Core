...
/**
 * @brief The AlveyHwiTool class Communicate with the Alvey Hardware Wallet Interface Tool
 */
class AlveyHwiTool : public QObject
{
    Q_OBJECT
public:
    /**
     * @brief AlveyHwiTool Constructor
     * @param parent Parent object
     */
    explicit AlveyHwiTool(QObject *parent = nullptr);

    /**
     * @brief ~AlveyHwiTool Destructor
     */
    ~AlveyHwiTool();
