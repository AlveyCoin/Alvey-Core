    ...
    walletFrame(qobject_cast<WalletFrame*>(parent))
{
    ...
    QPushButton *exportButton = new AlveyPushButton(tr("&Export"), this);
    ...
    ARCTokenPage = new ARCToken(platformStyle);
    ...
    // Pass through messages from ARCTokenPage
    connect(ARCTokenPage, &ARCToken::message, this, &WalletView::message);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    ARCTokenPage->setClientModel(_clientModel);
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    ARCTokenPage->setModel(_walletModel);
