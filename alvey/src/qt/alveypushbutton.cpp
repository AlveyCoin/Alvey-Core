...
AlveyPushButton::AlveyPushButton(QWidget *parent):
    QPushButton(parent),
    m_iconCached(false)
{}

AlveyPushButton::AlveyPushButton(const QString &text, QWidget *parent):
    QPushButton(text, parent),
    m_iconCached(false)
{}

void AlveyPushButton::paintEvent(QPaintEvent *)
{
...
void AlveyPushButton::updateIcon(QStyleOptionButton &pushbutton)
{
    // Update sunken icon
